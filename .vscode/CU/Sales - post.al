codeunit 50003 ServicePost_2
{
    ...
    var
        ...
        ServDocumentsMgt: Codeunit "Serv-Documents Mgt.2";
    ...
    local procedure OnAfterFinalizePostingOnBeforeCommit(var ServiceHeader: Record "Service Header"; var ServiceLine: Record "Service Line"; var ServDocumentsMgt: Codeunit "Serv-Documents Mgt.2"; var PassedShip: Boolean; var PassedConsume: Boolean; var PassedInvoice: Boolean)
    begin
    end;
