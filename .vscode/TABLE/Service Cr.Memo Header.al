tableextension 50064 ServiceCr_Memo_HeaderExtends extends "Service Cr.Memo Header"
{
    fields
    {
        //    VAT Base (retro.)
        ...
        field(50003; "Fiscal User"; COde[250])
        {
        ...
        field(50001; "Fiscal Printer Code"; Code[20])
        {
        ...
        field(70262; "Filters by Gauge"; Text[250])
        {
            ...
            //ĐEMINA   TableRelation = "Installation History"."Inventory Number" where(type = filter(Gauge), active = filter(true));
