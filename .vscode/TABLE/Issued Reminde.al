pageextension 50144 "Issued Reminder" extends "Issued Reminder"
{
    layout
    {
        ...
        addafter("&Reminder")
        {
            ...
            action("Reminder Send")
            {
                ...
                begin
                    ...
                    if Rec."Reminder Report Type" = "Reminder Report Type"::Custom then begin
                        ...
                        PathDoc := Encription.EncryptPdfForAccusationIss(filename, Month, Year, Rec, "Reminder Report Type"::Custom);
                        ...
                        Year := Date2DMY(Today, 3);
                        Reminder.SAVEASPDF(filename);
                        PathDoc := Encription.EncryptPdfForAccusationIss(filename, Month, Year, Rec, "Reminder Report Type"::Native);
                        FileManagement.DownloadToFile(filename, filename);
                        SMTPSetup.GET;
                        Recipients.Add(Customer."E-Mail");
                        gls.get();
            ...
            action(CreateAccusation)
            {
                ...
                var
                    ...
                    lines: Record "Issued Reminder Line";
    ...
    var
        ...
        AccusationReminder: Report IssuedAccusationReminder;
        mail: Boolean;
        post: Boolean;
