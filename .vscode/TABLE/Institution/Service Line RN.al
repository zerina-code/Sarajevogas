table 50102 "Service Line RN"
{
    ...
    fields
    {
        ...
        field(5; Type; Enum "Service Line Type")
        {
            ...
            begin
                ...
                if xRec.Type = xRec.Type::Item then
                    ServiceLineVerifyChange(Rec, xRec);
        ...
        field(80; "Attached to Line No."; Integer)
        {
            ...
            Editable = false;
            TableRelation = "Service Line RN"."Line No." WHERE("Document Type" = FIELD("Document Type"),
        ...
        field(50002; "Resource No."; Code[20])
        {
            ...
            if ("Resource Connection Type" = const(External)) Contact where("Type Relation" = field("Request Resource Type1"));
    ...
    keys
    {
        key(Key1; "Document Type", "Document No.", "Line No.", "Massive Code")
        {
            Clustered = true;
        }
    ...
    var
        Item: Record Item;
        ServiceLine2: Record "Service Line RN";
    begin
        TestStatusOpen;
        if Type = Type::Item then
            ServiceLineDelete(Rec);
    ...
    begin
        ...
        if "Unit of Measure Code2" = '' then
            validate("Unit of Measure Code2", 'SAT');
        if TempTrackingSpecification.FindFirst then
            InsertItemTracking;

        if Quantity <> 0 then
            VerifyQuantity(Rec, xRec);
    ...
    var
        ...
        ServiceLine: Record "Service Line RN";
    ...
    procedure DelNonStockFSM(var ServInvLine2: Record "Service Line RN")
    begin
    ...
    procedure VerifyQuantity(var NewServiceLine: Record "Service Line RN"; var OldServiceLine: Record "Service Line RN")
    var
        ServiceLine: Record "Service Line RN";
    begin
        with NewServiceLine do begin
            ...
            if "Line No." = 0 then
                if not ServiceLine.Get("Document Type", "Document No.", "Line No.") then
                    exit;
            /* SetReservSource(NewServiceLine);
    ...
    procedure DeleteLine(var ServLine: Record "Service Line RN")
    begin
    ...
    procedure ServiceLineDelete(var ServiceLine: Record "Service Line RN")
    begin
        /*   if WhseLinesExist(
                DATABASE::"Service Line RN", ServiceLine."Document Type".AsInteger(), ServiceLine."Document No.",
    ...
    begin
        ...
        if ((SourceType = DATABASE::"Purchase Line") and (SourceSubType = 1) and (SourceQty < 0)) or
           ...
           ((SourceType = DATABASE::"Service Line RN") and (SourceSubType = 1))
        then begin
    ...
    procedure FindReservEntry(ServiceLine: Record "Service Line RN"; var ReservEntry: Record "Reservation Entry"): Boolean
    begin
    ...
    begin
        ...
        if Reserve = Reserve::Never then
            FieldError(Reserve);
        ReservQuantity(Rec, QtyToReserve, QtyToReserveBase);
        if QtyToReserveBase <> 0 then begin
            ReservMgt.SetReservSource(Rec);
            if ReplaceServItemAction then begin
                FindReservEntry(Rec, ReservationEntry);
    ...
    var
        TempServLine: Record "Service Line RN" temporary;
    begin
        TempServLine := Rec;
        Init;
    ...
    procedure ItemServiceSubstGet(var ServInvLine2: Record "Service Line RN")
    var
    ...
    procedure CallItemTracking(var ServiceLine: Record "Service Line RN")
    var
    ...
    begin
        ReservEntry.SetSource(DATABASE::"Service Line RN", "Document Type".AsInteger(), "Document No.", "Line No.", '', 0);
    ...
    begin
        ReservEntry.SetSourceFilter(DATABASE::"Service Line RN", "Document Type".AsInteger(), "Document No.", "Line No.", false);
    ...
    var
        "Field": Record "Field";
    begin
        Field.Get(DATABASE::"Service Line RN", FieldNumber);
    ...
    procedure CalcVATAmountLines(QtyType: Option General,Invoicing,Shipping,Consuming; var ServHeader: Record "Service Header"; var ServiceLine: Record "Service Line RN"; var VATAmountLine: Record "VAT Amount Line"; isShip: Boolean)
    var
    ...
    procedure UpdateVATOnLines(QtyType: Option General,Invoicing,Shipping; var ServHeader: Record "Service Header"; var ServiceLine: Record "Service Line RN"; var VATAmountLine: Record "VAT Amount Line")
    var
    ...
    var
        ItemLedgEntry: Record "Item Ledger Entry";
        ServLine3: Record "Service Line RN";
    begin
    ...
    begin
        exit(
            ItemTrackingMgt.ComposeRowID(
                DATABASE::"Service Line RN", "Document Type".AsInteger(), "Document No.", '', 0, "Line No."));
    end;
        ...
        if "Document Type" = "Document Type"::Order then
            if Location2."Directed Put-away and Pick" then begin
                ...
                if (Quantity >= 0) and (Location2."Require Shipment" or Location2."Require Pick") then begin
                    if WhseValidateSourceLine.WhseLinesExist(DATABASE::"Service Line RN", "Document Type".AsInteger(), "Document No.", "Line No.", 0, Quantity)
                    then
                        ShowDialog := ShowDialog::Error
                    else
                ...
                if (Quantity < 0) and (Location2."Require Receive" or Location2."Require Put-away") then begin
                    if WhseValidateSourceLine.WhseLinesExist(
                         DATABASE::"Service Line RN", "Document Type".AsInteger(), "Document No.", "Line No.", 0, Quantity)
                    then
                        ShowDialog := ShowDialog::Error
                    else
    ...
    procedure GetNextLineNo(ServiceLineSource: Record "Service Line RN"; BelowxRec: Boolean): Integer
    var
        ServiceLine: Record "Service Line RN";
        LowLineNo: Integer;
        HighLineNo: Integer;
    ...
    var
        ServLine: Record "Service Line RN";
    begin
        if "Line No." <> 0 then
    ...
    procedure ReservQuantity(ServLine: Record "Service Line RN"; var QtyToReserve: Decimal; var QtyToReserveBase: Decimal)
    begin
    ...
    procedure ServiceLineVerifyChange(var NewServiceLine: Record "Service Line RN"; var OldServiceLine: Record "Service Line RN")
    var
        NewRecRef: RecordRef;
        OldRecRef: RecordRef;
    begin
        if not WhseLinesExist(
             DATABASE::"Service Line RN", NewServiceLine."Document Type".AsInteger(), NewServiceLine."Document No.", NewServiceLine."Line No.", 0,
    ...
    var
        ...
        ServInvLine: Record "Service Line RN";
