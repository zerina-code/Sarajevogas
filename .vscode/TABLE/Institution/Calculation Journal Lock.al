/*table 50091 "Calculation Journal Line Lock"
{
    ...
    keys
    {
        ...
        key(CategoryDate; "Category MM", "Calculation Date To")
        {
            Clustered = false;
        }

        key(GaugeDate; Gauge, "Calculation Date To", "Reading Date To") { }
        ...
        key(ExportVP; "Measuring Point Stroke", "Measuring Point String", "Street No. Int MM", "Zone stroke MM")
        {
