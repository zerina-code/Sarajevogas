report 50191 "Leveling report Preview2"
{
    DefaultLayout = RDLC;
    PreviewMode = Normal;
    ...
    dataset
    {
        dataitem(DataItem1; "Item Journal Line")
        {
            ...
            column(Wholesale_Unit_Price; "Unit Price New") { }
            column(OldV; OldV) { }
            column(NewValue; NewValue) { }
            column(Niv; Niv) { }
            column(ItemV; ItemV) { }
            column(UnitM; UnitM) { }
            column(Valued_Quantity; "Quantity") { }
            column(NiB; NiB) { }
            ...
            begin
                ...
                OldPrice := "Unit Price Old";



                Niv := DataItem1."Quantity" * DataItem1."Unit Price Old" - DataItem1."Quantity" * OldPrice;
                OldV := DataItem1."Quantity" * OldPrice;
                NewValue := DataItem1."Quantity" * DataItem1."Unit Price New";
                ItemG.Get(DataItem1."Item No.");
                ItemV := ItemG.Description;
                UnitM := ItemG."Sales Unit of Measure";
                NiB := DataItem1."Document No.";
