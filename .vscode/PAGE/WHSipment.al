codeunit 50014 "Whse.-Post Shipment_2"
{
    ...
    begin
        ...
        PostedWhseShptHeader."RN Source" := WhseShptHeader."RN Source";
        PostedWhseShptHeader."G/L Account No." := WhseShptHeader."G/L Account No.";
        PostedWhseShptHeader.Address := WhseShptHeader.Address;
