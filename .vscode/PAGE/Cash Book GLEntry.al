report 50188 "Cash Book GL"
{
    //ED
    DefaultLayout = RDLC;
    RDLCLayout = './Cash Book GL.rdl';
    ...
    dataset
    {
        dataitem(DataItem22; "Gen. Journal Line")
        {
            ...
            column(testnopolje; "Bal. Account No.")
            { }
            ...
            column(GLNo; DataItem22."Line No.")
            {
            }
            ...
            begin
                ...
                if banacc.get("Bal. Account No.") then begin
            ...
            begin
                DataItem22.SetFilter("Bal. Account No.", '<>%1', '');
