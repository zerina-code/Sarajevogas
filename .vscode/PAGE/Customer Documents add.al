page 50099 "Customer Documents"
{
    Caption = 'Customer Documents';
    SourceTable = "A-B Attachments";
    SourceTableView = where(Source = filter(Customer));
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Send Mails")
            {
                ...
                trigger OnAction()
                var
                    ReportSend: report "Send Mails";
                begin


                    Report.RunModal(50192, true, false, Rec);
