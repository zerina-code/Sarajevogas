codeunit 50017 "Serv-Documents Mgt.2"
{
    ...
    var
        ...
        SIH2: Record "Service Invoice Header";
    begin
        with ServHeader do begin
            ServInvHeader.Init();
            ...
            //ovdje ne, ako već ima kreirana
            SIH.Reset();
            SIH.SetFilter("Order No.", ServInvHeader."Order No.");
            if not SIH.FindFirst() then begin
                ...
                SIH2.Reset();
                SIH2.SetFilter("Order No.", ServInvHeader."Order No.");
                if sih2.FindFirst() then
                    ServInvHeader."No." := sih2."No.";
