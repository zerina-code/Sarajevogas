report 50159 "Calculate Inventory v1" //Customized version of Microsoft original report id 790
{
    Caption = 'Calculate Inventory For Employees';
    ProcessingOnly = true;
    ...
    begin
        if SkipDim then
            ...
            DimSelectionBuf.CompareDimText(3, REPORT::"Calculate Inventory v1", '', ColumnDim, Text003);
        ZeroQtySave := ZeroQty;
    end;
        ...
        with ItemJnlLine do begin
            ...
            if (Quantity2 <> 0) or ZeroQty then begin
                ...
                if ItemLedgEntry.FindLast then begin
                    ...
                    "Employee No." := ItemLedgEntry."Employee No."; //amir dodao
                    "Employee Name" := ItemLedgEntry."Employee Name";
                end else begin
                    "Last Item Ledger Entry No." := 0;
                    "Employee No." := ItemLedgEntry."Employee No.";
                    "Employee Name" := ItemLedgEntry."Employee Name";
                end;
