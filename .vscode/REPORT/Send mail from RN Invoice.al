report 50212 "Send mail from RN Invoice"
{
    ...
    dataset
    {
        ...
        dataitem(DataItem2; "Service Invoice Header")
        {
            ...
            begin
                ...
                if Confirm('Da li ste sigurni da želite poslati mail kupcu?') then begin
                    ...
                    ResultReplace := Replacestring_TName(ResultReplace, '@BrojDokumenta', DataItem2."CZK Request No.");
