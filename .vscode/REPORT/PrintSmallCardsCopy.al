report 50118 PrintSmallCardsCopy
{
    DefaultLayout = RDLC;
    RDLCLayout = './PrintSmallCardsCopy.rdl';
...

    {
        ...
        dataitem(DataItem21; "Posted Whse. Receipt Line")

        {
            ...
            var
                WRLOrg: Record "Posted Whse. Receipt Line";
                i: Integer;
                LineNo: Integer;
            begin
                BrojacReda := 0;
    ...
    var
        ...
        WRL: Record "Posted Whse. Receipt Line";
        ...
        PostedWarehouseReceiptHeaderTable: Record "Posted Whse. Receipt Header";
        TotalCards: Integer;
        NoOfLoops: Integer;
