report 50110 "Order Copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './OrderCopy.rdl';
    Caption = 'Order Copy';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Purchasedate; "Document Date")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoPurchaseEmail; CompanyInfo."Purchase E-mail")
                    {
                    }
                    column(CompanyInfoPurchasePhoneNo; CompanyInfo."Purchase Phone No.")
                    {
                    }
                    ...
                    column(Picture3; CompanyInfo.picture3) { }
                ...
                begin
                    ...
                    Vendor.Reset();
                    Vendor.SetFilter("No.", '%1', "Purchase Header"."Buy-from Vendor No.");
            ...
            begin
                ...
                PurchaseContract.SetFilter("Contract Entry No.", '%1', "Purchase Header"."Contract Entry No.");
                if PurchaseContract.FindFirst() then begin
                    DatumUgovora := PurchaseContract."Contract Start Date";
                end;
                User.reset;
                User.SetFilter("User Name", '%1', "Purchase Header"."User ID Number");
    ...
    begin
        GLSetup.Get();
        CompanyInfo.Get();
        CompanyInfo.CalcFields(Picture, Picture1, Picture3);
        PurchSetup.Get();
    ...
    var
        ...
        CompanyInfoRegistrationNo: Text;
        CompanyInfoPurchasePhoneNo: Text;
        CompanyInfoPurchaseEmail: Text;
        VendorFaxNo: Text[50];
        VendorEmail: Text[50];
        LineNo: integer;
        LineNoCaption: Label 'Total';
