report 50121 PrintSmallCardsOrder
{
    DefaultLayout = RDLC;
    RDLCLayout = './PrintSmallCardsOrder.rdl';
...

    {
        ...
        dataitem(DataItem21; "Purch. Rcpt. Line")

        {
            ...
            begin
                ...
                PostedWarehouseReceiptHeaderTable.Reset();
                PostedWarehouseReceiptHeaderTable.SetFilter("No.", '%1', PostedWarehouseReceiptNoFilter);
                if PostedWarehouseReceiptHeaderTable.FindFirst() then
                    ReceiptPostingDate := PostedWarehouseReceiptHeaderTable."Posting Date";

                Addr[1] [1] := StrSubstNo('%1 %2', 'NAZIV', '');
                Addr[1] [2] := StrSubstNo('%1 %2', ItemDescription, '');
                Addr[1] [3] := StrSubstNo('%1 %2', '' + PostedWarehouseReceiptNoFilter + ' od ' + FORMAT(ReceiptPostingDate), '');
                Addr[1] [4] := StrSubstNo('%1 %2', "No.", '');
            ...
            begin
                ...
                WRLOrg.Reset();
                WRLOrg.SetFilter("No.", '%1', PostedWarehouseReceiptNoFilter);
                LineNo += 100;
    ...
    begin
        PostedWarehouseReceiptNoFilter := WarehouseReceiptNo;
    end;
    ...
    var
        ...
        WRL: Record "Purch. Rcpt. Line";
        PostedWarehouseReceiptNoFilter: Code[20];
        PrvaKolonaV: Boolean;
        ...
        PostedWarehouseReceiptHeaderTable: Record "Purch. Rcpt. Header";
        TotalCards: Integer;
        NoOfLoops: Integer;
