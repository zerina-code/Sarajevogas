report 50120 "Purchase - Receipt-Copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchaseReceiptCopy.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(Vendor_Shipment_No_; "Purch. Rcpt. Header"."Vendor Shipment No.")
            {

            }
            column(Assigned_User_ID; "Purch. Rcpt. Header"."Assigned User ID")
            {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        column(ResponsiblePosition; ResponsiblePosition)
                        {
                        ...
                        column(DestinationTest; DestinationTest)
                        {
                        ...
                        begin
                            Location.reset();
                            Location.SetFilter("Code", '%1', "Purch. Rcpt. Line"."Location Code");
                            if Location.FindFirst() then begin

                                Responsible := location."Responsible Person Name";
                                ResponsiblePosition := Location."Responsible Person Position";
                                DestinationTest := Location.Name;
                            end;
    ...
    var
        DestinationTest: Text[150];
        ResponsiblePosition: Text[150];
        Responsible: text[150];
