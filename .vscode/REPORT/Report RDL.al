report 50205 "Service Order General RDL"
{

    //Service Order General RDL

    DefaultLayout = RDLC;
    PreviewMode = Normal;
    WordMergeDataItem = "Service Item Line";
    RDLCLayout = './Service Order General RDL.rdl';
    ...
    dataset
    {
        dataitem("Service Item Line"; "Service Item Line")
        {
            ...
            column(CZKRN; CZKRN) { }
            column(MMF; "Service Item Line"."Service Item No. - Relation") { }

            column(MMF2; "Service Item Line".Address) { }

            column(MMF3; "Service Item Line"."Street No. Text MM") { }
            column(MMF4; "Service Item Line".Mark) { }
            ...
            column(CustName_GAS; "Service Item Line".Description) { }
            ...
            column(DateOfRealisation; format(ServiceHeaderAdd."Finishing Date", 0, '<day,2>.<month,2>.<year4>')) { }
 ...
 */
                ...
                group(Option)
                {
                    field(ReportLayout; ReportLayout)
                    {
                        ...
                        begin
                            ...
                            CustomReportLayout.SetFilter("Report ID", '%1', 50205);
    ...
    begin
        CL.Reset();
        CL.SetFilter("Report ID", '%1', 50205);
