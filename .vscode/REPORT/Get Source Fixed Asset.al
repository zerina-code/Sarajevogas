report 50002 "Get Source Fixed Asset"
{
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    begin
                        ...
                        if not SkipWarehouseRequest("Sales Line", "Warehouse Request") then
                            case RequestType of
                                RequestType::Receive:
                                    if CheckIfSalesLine2ReceiptLine2("Sales Line") then begin
                ...
                dataitem("Purchase Line"; "Purchase Line")
                {
                    ...
                    begin
                        ...
                        if Type = Type::"Fixed Asset" then
                            VerifyFixedAssetNotBlocked("No.");

                        if "Location Code" = "Warehouse Request"."Location Code" then
                            case RequestType of
                                RequestType::Receive:
                                    if CheckIfPurchLine2ReceiptLine2("Purchase Line") then begin
                    ...
                    trigger OnPreDataItem()
                    begin
                        SetRange(Type, Type::Item, Type::"Fixed Asset");
    ...
    procedure CheckIfPurchLine2ReceiptLine2(PurchLine: Record "Purchase Line"): Boolean
    var
        ReturnValue: Boolean;
        IsHandled: Boolean;
    begin
    ...
    begin
        ...
        if "Warehouse Request"."Destination Type" = "Warehouse Request"."Destination Type"::Vendor then begin
            WhseReceiptHeader."Vendor No." := "Warehouse Request"."Destination No.";
        end;
        if "Warehouse Request"."Source Document" = "Warehouse Request"."Source Document"::"Purchase Order" then begin
            PH.Reset();
            PH.SetFilter("Document Type", '%1', PH."Document Type"::Order);
            PH.SetFilter("No.", '%1', "Warehouse Request"."Source No.");
            if PH.FindFirst() then begin
                WhseReceiptHeader."Vendor Name" := PH."Buy-from Vendor Name";
    ...
    var
        IsHandled: Boolean;
        CFind: Codeunit "Get Source Doc. Inbound";
    begin
    ...
    local procedure VerifyFixedAssetNotBlocked(ItemNo: Code[20])
    var
        FixedAsset: Record "Fixed Asset";
    begin
        FixedAsset.Get(ItemNo);
    ...
    procedure CheckIfSalesLine2ReceiptLine2(SalesLine: Record "Sales Line"): Boolean
    var
        WhseReceiptLine: Record "Warehouse Receipt Line";
