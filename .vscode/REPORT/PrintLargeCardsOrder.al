report 50122 PrintLargeCardsOrder
{
    DefaultLayout = RDLC;
    RDLCLayout = './PrintLargeCardsOrder.rdl';
...

    {
...

        {
            ...
            begin
                ...
                PostedWarehouseReceiptHeaderTable.SetFilter("No.", '%1', "No.");
                ...
                Addr[ColumnNo] [4] := StrSubstNo('%1 %2', "No.", '');
