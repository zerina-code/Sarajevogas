report 50065 "ZR-OU-00-25-01"
{
    Caption = 'ZR-OU-00-25-01', Locked = true;
    DefaultLayout = Word;
    WordLayout = '.\.vscode\REPORT\WORD\ZR-OU-00-25-01.docx';
    dataset
    {
        dataitem(ServiceHeader; "Service Header")
        {
            ...
            column(Execution_Protocol_No_; "Execution Protocol No.") { }
    ...
    begin
        ...
        US.SetFilter("User ID", '%1', UserId);
        if US.FindFirst() then begin
            crl.SetFilter(code, '%1', us."Crl Code");
