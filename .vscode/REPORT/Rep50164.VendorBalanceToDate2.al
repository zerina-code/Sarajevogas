report 50164 VendorBalanceToDate2
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorBalancetoDate2.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'VendorBalanceToDate2';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(Phone_No_; CompInfo."Phone No.")
            {
            }
            ...
            column(Comp_Picture1; CompInfo.Picture1) { }
            column(Comp_Picture2; CompInfo.Picture2) { }
            column(Comp_Picture3; CompInfo.Picture3) { }
            column(Comp_Bill_Sign; CompInfo."Billing Signatory") { }
            ...
            dataitem(VendLedgEntry3; "Vendor Ledger Entry")
            {
                ...
                dataitem("Detailed Vendor Ledg. Entry"; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    column(RowNo; VendLedgEntryCounter)
                    {
                    }
                    ...
                    begin
                        ...
                        VendLedgEntryCounter := VendLedgEntryCounter + 1;
                    end;

                    trigger OnPreDataItem()
                    begin
                        VendLedgEntryCounter := 0;
    ...
    begin
        ...
        CompInfo.Get();
        CompInfo.CalcFields(Picture, Picture1, Picture2, Picture3, "Billing Signatory");
