report 50116 "Transfer Copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TransferShipmentCopy.rdl';
    Caption = 'Transfer Shipment';
    //TransferShipmentCopyPreviewMode = PrintLayout;
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            column(Transfer_Order_Date; "Transfer Shipment Header"."Transfer Order Date")
            {
            ...
            column(Transferfrom; "Transfer Shipment Header"."Transfer-from Name")
            {

            }
            column(TransferTo; "Transfer Shipment Header"."Transfer-to Name")
            {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PostDate_TransShptHeader; "Transfer Shipment Header"."Posting Date")
                    {
                    }
            ...
            begin
                Location.reset();
                Location.SetFilter("Code", '%1', "Transfer Shipment Header"."Transfer-from Code");
