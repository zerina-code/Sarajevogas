report 50179 "GenralTestJournal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './GeneralJournalTest.rdl';
    ...
    begin
        with GenJnlLine do
            if not Employee1.Get("Account No.") then
                AddError(StrSubstNo(Text031, Employee1.TableCaption, "Account No."))
            else begin
                AccName := Employee1."No.";
                if Employee1."Privacy Blocked" then
                    AddError(StrSubstNo(Text032, Employee1.FieldCaption("Privacy Blocked"), false, Employee1.TableCaption, AccName))
            end;
    end;
