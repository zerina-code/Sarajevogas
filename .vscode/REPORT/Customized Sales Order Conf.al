report 50158 "Customized Sales Order Conf"
{
    //Ovo je kopija Microsoftovog izvještaja: report 1305 "Standard Sales - Order Conf."
    RDLCLayout = './CustomizedSalesOrderConf.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(CustomerName; CustomerCustom.Name) { }
            column(CustomerAddress; CustomerCustom.Address) { }
            column(CustomerPostCode; CustomerCustom."Post Code") { }
            column(CustomerCity; CustomerCustom.City) { }
            column(CustomerTaxLiable; CustomerCustom."Tax Liable") { }
            column(CustomerRegNo; CustomerCustom."Registration No.") { }
            column(CEO_Phone; CEO_Phone) { }
            column(CompOperaterPhone; CompanyInfo."Operater No") { }
            column(CompFaxNo; CompanyInfo."Fax No.") { }
            column(CompFaxNo2; CompanyInfo.Fax2) { }
...
ORG.Reset();
            ...
            begin
                ...
                CustomerCustom.Reset();
                CustomerCustom.Get("Bill-to Customer No.");
            end;
        }
    }
    ...
    var
        ...
        CustomerCustom: Record Customer;
        transaction1, transaction1Name : text[100];
        transaction2, transaction2Name : text[100];
        transaction3, transaction3Name : text[100];
        transaction4, transaction4Name : text[100];
        transaction5, transaction5Name : text[100];
        transaction6, transaction6Name : TEXT[100];
        transaction7, transaction7Name : Text[100];
        transaction8, transaction8Name : TEXT[100];
        transaction9, transaction9Name : TEXT[100];
        transaction10, transaction10Name : TEXT[100];
        Head: Record "Head Of's";
        CEO_Phone: Text[100];
        ORG: Record "ORG Shema";
        LineCounter: Integer;
        LineAmountTotal: Decimal; //total vrijednosti bez PDVa
