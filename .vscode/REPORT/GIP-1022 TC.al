report 50034 "GIP-1022 TC"
{
    DefaultLayout = RDLC;
    RDLCLayout = './GIP-1022 TC.rdl';
    ...
    dataset
    {
        dataitem(DataItem1; "Employee")
        {
            ...
            column(ZaposlenikAdresa1; "Address CIPS")
            {
            }
            ...
            dataitem(DataItem29; "Wage Calculation")
            {
                ...
                column(Type; "Wage Calculation Type")
                {
                }
                ...
                begin
                    ...
                    t_ContrEmp.SETFILTER(t_ContrEmp."Payment Date", '%1', "Payment Date");
                    t_ContrEmp.SETFILTER(t_ContrEmp."Contribution Code", '%1', 'D-PIO-NA');
                    ...
                    t_ContrEmp1.SETFILTER(t_ContrEmp1."Payment Date", '%1', "Payment Date");
                    ...
                    t_ContrEmp2.SETFILTER(t_ContrEmp2."Payment Date", '%1', "Payment Date");
